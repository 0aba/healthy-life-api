    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('balance', models.DecimalField(decimal_places=9, default=0, max_digits=12, verbose_name='Бланс')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('award', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='award_fk', to='user.awards', verbose_name='Награда')),
                ('award_user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='award_user_fk', to=settings.AUTH_USER_MODEL, verbose_name='Наградить пользователя')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_notify', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_notify_fk', to=settings.AUTH_USER_MODEL, verbose_name='Уведомляемый пользователь')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('messages_from_friends_only', models.BooleanField(default=False, verbose_name='Получать сообщения только от друзей')),
                ('receive_notifications_about_discounts', models.BooleanField(default=False, verbose_name='Получать уведомления об скидках')),
                ('user_settings', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='settings_fk', to=settings.AUTH_USER_MODEL)),
            ],
            options={
