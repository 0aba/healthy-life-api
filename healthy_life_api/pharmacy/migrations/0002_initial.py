...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='goodsreview',
            name='reply',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_reply', to='pharmacy.goodsreview', verbose_name='Ответ на сообщение'),
        ),
        migrations.AddField(
            model_name='goodsreview',
            name='wrote',
