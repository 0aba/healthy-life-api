...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Purchase',
            fields=[
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='Идентификатор покупки')),
                ('date_buy', models.DateField(null=True, verbose_name='Время покупки')),
                ('for_money', models.DecimalField(decimal_places=9, max_digits=10, null=True, verbose_name='Купил за сумму биткоин')),
                ('transaction_execution', models.BooleanField(default=False, verbose_name='Заблокирован на время транзакции')),
        ...
        migrations.CreateModel(
            name='Goods',
            fields=[
                ('name', models.CharField(max_length=1024, primary_key=True, serialize=False, verbose_name='Название товара')),
                ...
                ('price', models.DecimalField(decimal_places=9, max_digits=10, verbose_name='Цена биткоин')),
